...
- **The file** `setub.bat` **downloads pip <img src="icon\PyPI.png" alt="pip" width="50"> Python packages PyPI** [![PyPI](https://img.shields.io/badge/PyPI-3775A9?logo=pypi&logoColor=fff)](#)
